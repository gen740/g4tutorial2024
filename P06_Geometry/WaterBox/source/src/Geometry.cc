...
//------------------------------------------------------------------------------
auto Geometry::Construct() -> G4VPhysicalVolume*
//------------------------------------------------------------------------------
{
  ...
  auto* physVol_World =
      new G4PVPlacement{G4Transform3D(), "PhysVol_World", logVol_World,
                        nullptr,         false,           copyNum_World};
  ...
  auto* solid_WaterBox =
      new G4Box{"Solid_WaterBox", leng_X_WaterBox / 2.0, leng_Y_WaterBox / 2.0,
                leng_Z_WaterBox / 2.0};

  // Define the logical volume
  G4Material* materi_WaterBox = materi_Man->FindOrBuildMaterial("G4_WATER");
  auto* logVol_WaterBox =
      new G4LogicalVolume{solid_WaterBox, materi_WaterBox, "LogVol_WaterBox",
